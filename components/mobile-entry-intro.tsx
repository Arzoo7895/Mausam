...
export function MobileEntryIntro() {
  ...
  return (
    <section className="mobile-entry" aria-label="Mausam AI introduction">
      ...
      <div className="entry-content">
        <div className="logo-lockup">
          <div className="logo-mark" aria-hidden="true">
            <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/FIMT%20IEEE%20Student%20Branch%20logo_20260917_205642_0001-8Ce9mCSNbVBTAqq9snkNDJeEYvS9Ay.png" alt="" />
          </div>
