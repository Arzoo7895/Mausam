...
function Brand() { return <div className="flex items-center gap-2.5 px-2"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-09-19%20at%2019.27.44-diphBTjK14zaWkToICApMTDSFOtSPR.jpeg" alt="Mausam AI" className="size-8 rounded-[10px] object-cover" /><span className="text-base font-semibold tracking-tight">Mausam <span className="text-muted-foreground">AI</span></span></div> }
